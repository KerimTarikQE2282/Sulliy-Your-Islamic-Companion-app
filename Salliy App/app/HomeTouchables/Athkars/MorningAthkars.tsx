...
export default function Index() {
  const [sound, setSound] = React.useState<Audio.Sound | null>(new Audio.Sound());
    ...
    >
      <View className="flex-1">
        <View className="flex-col gap-0 min-h-screen pb-10 ">
          ...
          >
         <TouchableOpacity onPress={()=>PlaySound()} className="text-white"><Text>play</Text></TouchableOpacity>
         <TouchableOpacity onPress={()=>stopSound()} className="mt-10"><Text>Pause</Text></TouchableOpacity>
          </View>
